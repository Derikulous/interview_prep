# 5) Given an array of integer elements, a subsequence of this array is a
# set of consecutive elements from the array (i.e: given the array
...
# o the difference between the sum of the elements in the right subsequence
...
# • all the elements in the array are integer numbers in the following
# range: [-1000, 1000]
